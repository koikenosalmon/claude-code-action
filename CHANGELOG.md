...
## Fork Changes (koikenosalmon/claude-code-action@beta)
...
- **Updated Base Action**: Uses `koikenosalmon/claude-code-base-action@beta` which includes OAuth credential handling
